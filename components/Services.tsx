    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl lg:text-4xl mb-4 text-gray-900">Hizmetlerimiz</h2>
          ...
          {services.map((service, index) => (
            <Card key={index} className="group hover:shadow-lg transition-all duration-300 border-gray-100">
              <CardContent className="p-6 md:p-8 text-center">
                ...
                <h3 className="text-lg md:text-xl mb-3 md:mb-4 text-gray-900">{service.title}</h3>
