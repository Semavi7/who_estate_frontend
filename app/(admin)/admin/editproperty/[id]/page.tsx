      ...
      if (id) {
        ...
        setTimeout(() => {
          const mockData = {
            ...
            description: "Muhteşem deniz manzaralı, modern donanımlı villa. Özel bahçe ve havuz mevcut.",
            price: "2500000",
            grossArea: "350",
            netArea: "300",
            rooms: "4+2",
            ...
            district: "besiktas",
            neighborhood: "bebek",
            address: "Bebek Mahallesi, Deniz Caddesi No: 15",
            coordinates: { lat: 41.0766, lng: 29.0434 },
            features: ["Deniz Manzarası", "Güney Cephe", "Havuz", "Bahçe", "Ankastre Mutfak", "Klima"],
            existingImages: ["villa1.jpg", "villa2.jpg", "villa3.jpg"],
            images: []
          };
  ...
  const handleSubmit = async () => {
    ...
    Object.entries(formData).forEach(([key, value]) => {
      if (key === 'images') {
        ...
        submitData.append('existingImages', JSON.stringify(value));
        ...
        <CardContent>
          <div className="bg-gray-100 h-64 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">Mevcut konum: {formData.coordinates.lat}, {formData.coordinates.lng}</p>
            </div>
          </div>
        </CardContent>
      </Card>
  ...
  const renderStep5 = () => (
    <div className="space-y-6">
      ...
      {formData.existingImages.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>Mevcut Fotoğraflar ({formData.existingImages.length})</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Yeni Fotoğraf Yükleme</CardTitle>
        </CardHeader>
        <CardContent>
          <div
      ...
      {formData.images.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>Yeni Eklenen Fotoğraflar ({formData.images.length})</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h2 className="text-2xl">İlan Düzenle</h2>
            <p className="text-gray-600">İlan bilgilerini güncelleyin</p>
          </div>
        </div>
